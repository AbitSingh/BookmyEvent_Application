...
public class UsuarioController {
	...
	public String register(Model model, Usuario usuario) {
		...
		if (registroOk == 1) {
			mensaje = "<span style=\"color: green; font-weight: 500;\"> User registered successfully! Log in your account!</span>";
			model.addAttribute("mensaje", mensaje);
			return "index";
		} else {
			mensaje = "<span style=\"color: red; font-weight: 500;\">An error occurred while registering the user!</span>";
			model.addAttribute("mensaje", mensaje);
			return "index";
		}
	}
