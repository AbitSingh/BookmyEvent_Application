<%-- Yeah Starting vala login and register page hai; --%>
...
<html>
  ...
  <div class="container info-block">
    <div class="px-4 py-5 my-0 text-center">
      ...
      <h1 class="display-5 fw-bold">What is BookmyEvent?</h1>
      <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">BookmyEvent is a website where you can register for any free event with one simple click. Login with your account or create a new one, confirm your assistance and enjoy the event.</p>
      </div>
    </div>
  </div>
