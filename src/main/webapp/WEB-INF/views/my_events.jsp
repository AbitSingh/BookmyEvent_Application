...
<body>
    ...
    <c:choose>
        ...
        <div class="container event-container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 custom-gap">
        	<c:forEach var="ele" items="${listado}" varStatus="estado">    
            
                <div class="col">
                    <div class="card shadow-sm"   style="width: 230px; border-radius: 15px;">
                       <img class="card-img-top" width="100%" height="225"   style="border-radius: 15px;"    src="<c:url value="${ele.photos}" />"/>
                        <div class="card-body">
